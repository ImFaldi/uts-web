                                            ...
                                            <div class="card card-plain">
                                                ...
                                                <div class="card-body">
                                                    <form role="form text-left" method="POST"
                                                        action="{{ route('portofolio.store') }}" enctype="multipart/form-data">
                                                        @csrf
                                                        <label>Title</label>
                                ...
                                <tbody>
                                    @foreach ($portofolio as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0"><img src="{{ asset('images/' . $row->image) }}" alt="" width="100px"></p>
                                            </td>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-body p-0">
                                                                <div class="card card-plain">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <form role="form text-left" method="POST" action="{{ route('portofolio.update', $row->id) }}" enctype="multipart/form-data">
                                                                            @csrf
                                                                            <label>Title</label>
                                                                            <div class="input-group mb-3">
                                                                            ...
                                                                            <label>Description</label>
                                                                            <div class="input-group mb-3">
                                                                                <textarea class="form-control" placeholder="Description" aria-label="description" name="description" value="{{ $row->description }}"></textarea>
                                                                            </div>
                                                                            <label>Upload Image</label>
                                                                            <div class="input-group mb-3">
                                                                                <input type="file" class="form-control"
